...
func (o *Orchestrator) GetTenantConfig(ctx context.Context, tenantID string) (*TenantOrchestratorConfig, error) {
	// Check cache first
	o.configMu.RLock()
	cfg, exists := o.tenantConfigs[tenantID]
	o.configMu.RUnlock()
	...
	var cfgLoaded TenantOrchestratorConfig
	if err := json.Unmarshal(data, &cfgLoaded); err != nil {
		return nil, err
	}

	// Update cache
	o.configMu.Lock()
	o.tenantConfigs[tenantID] = &cfgLoaded
	o.configMu.Unlock()

	return &cfgLoaded, nil
}
